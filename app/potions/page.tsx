...
export const metadata: Metadata = {
  ...
  description:
    'Reference every StS2 potion effect with v0.104.0 beta patch framing, with guidance on how each potion ties into builds, cards, characters, and patches.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Browse potion effects with v0.104.0 beta patch framing so every pick fits your build, character, and card decisions.',
  },
};
