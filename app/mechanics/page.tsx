...
export const metadata: Metadata = {
  ...
  description:
    'Understand the current Early Access mechanics so you can tie Sly, Doom, Stars, Forge, Drawpile, and Exhaust back into the builds, tier lists, patch notes, and character hubs for the v0.105.1 beta hotfix and v0.105.0 beta patch watchlist.',
  keywords: [
      ...
      <section className="px-4 pt-6">
        <div className="container">
          <div className="rounded-2xl border border-border bg-card/80 p-6">
            ...
            <h2 className="text-2xl font-bold mt-1">Early Access v0.105.1 beta hotfix + v0.105.0 beta patch support</h2>
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: '/patches', label: 'Patch impact', description: 'Translate the v0.105.1 beta hotfix and v0.105.0 beta patch changes into pilotable adjustments.' },
