...
export const metadata: Metadata = {
  title: 'Slay the Spire 2 Builds v0.106.1 / v0.106.0: Best Current Builds by Character',
  description:
    'Find current Slay the Spire 2 builds for the active v0.106.1 / v0.106.0 Early Access cycle, with character build paths and links to patch notes, cards, and relic references.',
  alternates: {
    canonical: '/builds',
  },
  openGraph: {
    title: 'Slay the Spire 2 Builds v0.106.1 / v0.106.0: Best Current Builds by Character',
    description:
      'Best current Slay the Spire 2 builds for the active v0.106.1 / v0.106.0 Early Access cycle, with character build paths and links to patch notes, cards, and relic references.',
  },
};

const CURRENT_PATCH = 'v0.106.1 / v0.106.0';
...
const RESOURCE_CARDS = [
  ...
  },
  {
    ...
    copy: 'Start with the current enemy-rework / Aeonglass beta notes, then decide which build assumptions need retesting.',
    badge: 'Patch',
  },
  {
    href: '/cards',
      ...
      <div className="min-h-screen">
        <section className="relative h-[520px] overflow-hidden rounded-b-[3rem] bg-gradient-to-b from-forge-black via-shadow-gray to-shadow-gray">
          ...
          <div className="relative z-10 container mx-auto flex h-full flex-col justify-center gap-6 px-4 py-12 text-white">
            ...
            <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-5xl">Slay the Spire 2 builds for v0.106.1 / v0.106.0</h1>
