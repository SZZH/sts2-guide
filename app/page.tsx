...
export const metadata: Metadata = {
  ...
  description:
    'StS2 guide hub for Slay the Spire 2 builds, starter tips, mechanics, and searchable cards/relics/potions, including the official v0.105.1 beta hotfix watchlist.',
  openGraph: {
    title: 'StS2 Guide Hub: Slay the Spire 2 Builds, Tips, Cards, Relics',
    description:
      'Find beginner routes, mechanics explanations, patch analysis, and official v0.105.1 beta hotfix notes in one place.',
  },
};
...
export default function HomePage() {
  const heroTasks = [
    ...
    },
    {
      ...
      badge: 'Patch',
      title: 'Patch Impact',
      description: 'Live tracker for official beta notes and which strategies need a retest after v0.105.1.',
    },
    {
      href: '/characters',
      badge: 'Characters',
  ...
  const trustSignals = [
    { label: 'Updated for beta v0.105.1', detail: 'Built from official Steam notes first' },
        ...
        <section className="relative h-[620px] overflow-hidden border-b border-border">
          ...
          <div className="relative z-10 container mx-auto flex h-full flex-col items-center justify-center gap-6 px-4 text-center">
            ...
            <p className="max-w-2xl text-base md:text-xl text-steel-blue">
              ...
              tailored to beta v0.105.1 watchlist notes and the current Early Access narrative.
            </p>
